...
<body>
		<table cellpadding='3' cellspacing='3' class='tab_main'>
			...
			<footer align='center'>
			&copy; All Rights Reserved.	Click <a href="http://www.github.com/abhn/simple-php-mysql-project">here</a> for Github original source.	<?php if(isset($_SESSION["user_id"])) {echo $_SESSION["name"]; } ?>
			</footer>
</body>
</html>
